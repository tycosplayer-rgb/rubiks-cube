...
- 四**尖轴** 120° 转动（非面转）：`U层`/`L层`/`R层`/`B层` 为棱层（邻边/轴心带，不含尖，9 贴纸），`U尖`… 为只转尖角（3 贴纸）；角与棱独立转动
- **滑动拧层**：尖贴纸 / 投影超过 tip 阈值 → 角层；中带贴纸 → 棱层。尖轴按 tipPiece / 投影 / 深带归属 + 滑动打分选取（含底层尖），不只看最大 point·axis
