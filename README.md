...
| 入口 | URL | 说明 |
|------|-----|------|
| **推荐（非 github.io）** | https://d1b7gi-ip-34-193-108-177.tunnelmole.net/ | Tunnelmole HTTPS；当前 box 在线时可用 |
...
- **滑动拧面**：以手指下**当前**所在面为准（命中法线 · 面轴优先，点投影兜底），不再使用建模时的陈旧 `turnFace`；滑动方向与该面视觉转动一致（手指跟着贴纸走）
